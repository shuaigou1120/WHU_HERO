...
ui_5_frame_t ui_MODE_mode_0;

ui_interface_round_t *ui_MODE_mode_aim = (ui_interface_round_t*)&(ui_MODE_mode_0.data[0]);
ui_interface_round_t *ui_MODE_mode_follow = (ui_interface_round_t*)&(ui_MODE_mode_0.data[1]);
ui_interface_round_t *ui_MODE_mode_top = (ui_interface_round_t*)&(ui_MODE_mode_0.data[2]);
ui_interface_arc_t *ui_MODE_mode_direction = (ui_interface_arc_t*)&(ui_MODE_mode_0.data[3]);
ui_interface_rect_t *ui_MODE_mode_Rect = (ui_interface_rect_t*)&(ui_MODE_mode_0.data[4]);
...
void _ui_init_MODE_mode_0() {
    ...
    ui_MODE_mode_aim->start_x = 1417;
    ui_MODE_mode_aim->start_y = 698;
    ...
    ui_MODE_mode_follow->start_x = 1476;
    ui_MODE_mode_follow->start_y = 550;
    ...
    ui_MODE_mode_Rect->start_x = 1356;
    ui_MODE_mode_Rect->start_y = 384;
    ui_MODE_mode_Rect->width = 2;
    ui_MODE_mode_Rect->end_x = 1538;
    ui_MODE_mode_Rect->end_y = 771;


    ui_proc_5_frame(&ui_MODE_mode_0);
...
ui_string_frame_t ui_MODE_text_0;
ui_interface_string_t* ui_MODE_text_A = &(ui_MODE_text_0.option);

void _ui_init_MODE_text_0() {
    ui_MODE_text_0.option.figure_name[0] = 0;
    ui_MODE_text_0.option.figure_name[1] = 1;
    ui_MODE_text_0.option.figure_name[2] = 0;
    ui_MODE_text_0.option.operate_type = 1;

    ui_MODE_text_A->figure_type = 7;
    ui_MODE_text_A->operate_type = 1;
    ui_MODE_text_A->layer = 0;
    ui_MODE_text_A->color = 8;
    ui_MODE_text_A->start_x = 1409;
    ui_MODE_text_A->start_y = 723;
...
void _ui_remove_MODE_text_0() {
    ui_MODE_text_0.option.operate_type = 3;

    ui_proc_string_frame(&ui_MODE_text_0);
    SEND_MESSAGE((uint8_t *) &ui_MODE_text_0, sizeof(ui_MODE_text_0));
}
ui_string_frame_t ui_MODE_text_1;
ui_interface_string_t* ui_MODE_text_mode_text = &(ui_MODE_text_1.option);
...
void _ui_init_MODE_text_1() {
    ...
    ui_MODE_text_mode_text->start_x = 1452;
    ui_MODE_text_mode_text->start_y = 773;
...
ui_interface_string_t* ui_MODE_text_F = &(ui_MODE_text_2.option);
...
void _ui_init_MODE_text_2() {
    ...
    ui_MODE_text_F->start_x = 1471;
    ui_MODE_text_F->start_y = 572;
...
ui_interface_string_t* ui_MODE_text_T = &(ui_MODE_text_3.option);
...
void _ui_init_MODE_text_3() {
    ...
    ui_MODE_text_T->start_x = 1439;
    ui_MODE_text_T->start_y = 452;
    ui_MODE_text_T->width = 2;
    ui_MODE_text_T->font_size = 24;
    ui_MODE_text_T->str_length = 1;
    strcpy(ui_MODE_text_T->string, "T");
...
ui_interface_string_t* ui_MODE_text_hero_text = &(ui_MODE_text_4.option);
