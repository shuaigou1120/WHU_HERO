...
//	if (switch_is_mid(chassis_move_mode->chassis_data_->chassis_mode))
//    {
//        chassis_behaviour_mode =  CHASSIS_ZERO_FORCE;
//    }
//    else if (switch_is_down(chassis_move_mode->chassis_data_->chassis_mode))
//    {
//        chassis_behaviour_mode = CHASSIS_NO_FOLLOW_YAW;
//    }
//    else if (switch_is_up(chassis_move_mode->chassis_data_->chassis_mode))
//    {
//        chassis_behaviour_mode= CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW;
//    }
	if (chassis_move_mode->chassis_data_->chassis_mode==CHASSIS_ZERO_FORCE)
    {
        chassis_behaviour_mode =  CHASSIS_ZERO_FORCE;
    }
    else if (chassis_move_mode->chassis_data_->chassis_mode==CHASSIS_NO_FOLLOW_YAW)
    {
        chassis_behaviour_mode = CHASSIS_NO_FOLLOW_YAW;
    }
    else if (chassis_move_mode->chassis_data_->chassis_mode==CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW)
    {
        chassis_behaviour_mode=CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW;
    }
...
static void chassis_infantry_follow_gimbal_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *angle_set, chassis_move_t *chassis_move_rc_to_vector)
{
	*vx_set=chassis_move_rc_to_vector->chassis_data_->vx_set;
	*vy_set=chassis_move_rc_to_vector->chassis_data_->vy_set;
}
...
static void chassis_no_follow_yaw_control(fp32 *vx_set, fp32 *vy_set, fp32 *wz_set, chassis_move_t *chassis_move_rc_to_vector)
{
	...
	*vx_set=chassis_move_rc_to_vector->chassis_data_->vx_set;
	*vy_set=chassis_move_rc_to_vector->chassis_data_->vy_set;
    *wz_set=chassis_move_rc_to_vector->chassis_data_->wz_set;
}
