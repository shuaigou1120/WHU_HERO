...
//	feedback_update->gimbal_yaw_motor.self_aim_yaw_angle=Self_aim_data->shoot_yaw/3.14*180;
	...
	feedback_update->press=feedback_update->gimbal_rc_ctrl->rc.s[0];
}
...
//		gimbal_control_set->aimflag=0;
	}
//	chassis_data->chassis_mode=gimbal_control_set->gimbal_rc_ctrl->rc.s[0];
	chassis_data->chassis_mode=chassis_flag;
	chassis_data->selfaim_mode=gimbal_control_set->aimflag;
	chassis_data->shoot_mode=gimbal_control_set->gimbal_rc_ctrl->mouse.press_l;
...
//	chassis_data->selfaim_shoot_mode=2;
...
//	chassis_data->yawangle_set=yaw_angle_limit_func(chassis_data->yawangle_set-yaw_channel*YAW_RC_SEN);
	...
	if(chassis_data->chassis_mode!=0&&gimbal_control_set->aimflag==0&&turnflag==0)
	{
		...
		gimbal_control_set->gimbal_pitch_motor.absolute_angle_set-=pitch_channel*PITCH_RC_SEN_INS+gimbal_control_set->gimbal_rc_ctrl->mouse.y*PITCH_MOUSE_SEN*0.5;
		chassis_data->selfaim_shoot_mode=0;
	}
