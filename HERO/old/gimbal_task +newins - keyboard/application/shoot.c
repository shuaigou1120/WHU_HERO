...
//	//Ò£¿ØÆ÷¿ØÖÆ
//	shoot_control.last_press_l=shoot_control.press_l;
//	shoot_control.press_l=shoot_control.shoot_rc->rc.s[1];
}
void shoot_set_mode()
{
...
//Ò£¿ØÆ÷¿ØÖÆ
//if((shoot_control.last_press_l==2)&&(shoot_control.press_l==3))
//{
//	shoot_flag=!shoot_flag;
//}
...
void friction_control_set()
{
	...
	{
		shoot_control.friction_speed_set=8000;
		laser_on();
...
//	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_motor_measure[0]->speed_rpm,shoot_control.friction_speed_set);
	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_1_speed,-shoot_control.friction_speed_set);
	shoot_control.shoot_1_given_current=PID_calc(&shoot_control.friction_motor_current_pid,shoot_control.friction_motor_measure[0]->given_current,shoot_control.friction_motor_speed_pid.out);
	data1[0]=shoot_control.friction_2_speed;
	data1[1]=shoot_control.friction_1_speed;
//	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_motor_measure[1]->speed_rpm,-shoot_control.friction_speed_set);
	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_2_speed,shoot_control.friction_speed_set);
	shoot_control.shoot_2_given_current=PID_calc(&shoot_control.friction_motor_current_pid,shoot_control.friction_motor_measure[1]->given_current,shoot_control.friction_motor_speed_pid.out);
	
	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_3_speed,-shoot_control.friction_speed_set);
	shoot_control.shoot_3_given_current=PID_calc(&shoot_control.friction_motor_current_pid,shoot_control.friction_motor_measure[2]->given_current,shoot_control.friction_motor_speed_pid.out);
	
	
	PID_calc(&shoot_control.friction_motor_speed_pid,shoot_control.friction_4_speed,shoot_control.friction_speed_set);
	shoot_control.shoot_4_given_current=PID_calc(&shoot_control.friction_motor_current_pid,shoot_control.friction_motor_measure[3]->given_current,shoot_control.friction_motor_speed_pid.out);
