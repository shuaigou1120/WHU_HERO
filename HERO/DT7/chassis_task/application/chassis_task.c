...
//        chassis_move_control->vy_set = -sin_yaw * vx_set + cos_yaw * vy_set;
        ...
        //设置控制相对云台角度
        chassis_move_control->chassis_relative_angle_set =-6;
        //calculate ratation speed
        //计算旋转PID角速度
//        chassis_move_control->wz_set=0;
		if(chassis_move_control->chassis_relative_angle>-4 && chassis_move_control->chassis_relative_angle < -8 )
		{
			chassis_move_control->wz_set=0; 
		}
		else
