...
#define YAW_GYRO_PID_KP        6000.0f //-3000.0f
#define YAW_GYRO_PID_KI        15 //-5.0f
...
#define YAW_ANGLE_PID_KP        2.1  //0.09//0.8 //-4//-0.8
#define YAW_ANGLE_PID_KI        0.03      //0.2//0.2//-1
#define YAW_ANGLE_PID_KD       	-4.3 //0.1//-9//-5
#define YAW_ANGLE_PID_MAX_OUT   3.0f //3
