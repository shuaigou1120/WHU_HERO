...
extern ui_interface_line_t *ui_MODE_mode_FIRE;
extern ui_interface_round_t *ui_MODE_mode_unload;
...
extern ui_interface_string_t *ui_MODE_text_unload_text;
extern ui_interface_string_t *ui_MODE_text_fire_text;
