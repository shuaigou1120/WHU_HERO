...
//底盘旋转跟随PID
#define CHASSIS_FOLLOW_GIMBAL_PID_KP 0.2f      //0.2f//2.8   0.12
#define CHASSIS_FOLLOW_GIMBAL_PID_KI 0.001f  //1.0f//0.5       1.5
#define CHASSIS_FOLLOW_GIMBAL_PID_KD 0.1f  //4.0f            3.7
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_OUT 5.0f//6.0f//2.8
#define CHASSIS_FOLLOW_GIMBAL_PID_MAX_IOUT 0.05f
