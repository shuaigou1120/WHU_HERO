...
void get_42mm_shoot_heat_limit_and_heat(uint16_t *heat_limit_42mm, uint16_t *heat_42mm)
{
    *heat_limit_42mm = robot_state.shooter_barrel_heat_limit;
    *heat_42mm = power_heat_data_t.shooter_42mm_barrel_heat;
}
...
void get_speed_output(float *shoot_data)
{
	*shoot_data=shoot_data_t.bullet_speed;
}

void get_42mm_allowance(uint16_t *allowance_42mm)
{
	*allowance_42mm=bullet_remaining_t.projectile_allowance_42mm;
}