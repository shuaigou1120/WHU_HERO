...
static void gimbal_feedback_update(gimbal_control_t *feedback_update)
{
    ...
    feedback_update->gimbal_pitch_motor.motor_gyro = feedback_update->gryo->gryo_get->gyro[1];
//	feedback_update->gimbal_yaw_motor.absolute_angle = *(feedback_update->gimbal_INT_angle_point + INS_YAW_ADDRESS_OFFSET);
	...
	feedback_update->gimbal_yaw_motor.motor_gyro = arm_cos_f32(feedback_update->gimbal_pitch_motor.relative_angle) * (feedback_update->gryo->gryo_get->gyro[2])+arm_sin_f32(feedback_update->gimbal_pitch_motor.relative_angle) * (feedback_update->gryo->gryo_get->gyro[1]);
