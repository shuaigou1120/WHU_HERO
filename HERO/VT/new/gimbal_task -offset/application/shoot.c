...
*/
if(gimbal_control.keyboard&KEY_PRESSED_OFFSET_V&&(gimbal_control.lastkeyboard&KEY_PRESSED_OFFSET_V)==0)
{
	shoot_flag=!shoot_flag;
}
...
void friction_control_set()
{
	if(shoot_control.shoot_mode==SHOOT_BULLET)
	{
		...
		shoot_control.friction_speed_set=4000;
		shoot_control.friction_speed_set_1=3000;
		laser_on();
