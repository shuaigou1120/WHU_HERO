...
ui_interface_round_t *ui_MODE_mode_unload = (ui_interface_round_t*)&(ui_MODE_mode_0.data[2]);
ui_interface_round_t *ui_MODE_mode_follow = (ui_interface_round_t*)&(ui_MODE_mode_0.data[3]);
ui_interface_round_t *ui_MODE_mode_top = (ui_interface_round_t*)&(ui_MODE_mode_0.data[4]);
ui_interface_arc_t *ui_MODE_mode_direction = (ui_interface_arc_t*)&(ui_MODE_mode_0.data[5]);
ui_interface_rect_t *ui_MODE_mode_Rect = (ui_interface_rect_t*)&(ui_MODE_mode_0.data[6]);
...
void _ui_init_MODE_mode_0() {
    ...
    ui_MODE_mode_unload->figure_type = 2;
    ui_MODE_mode_unload->operate_type = 1;
    ui_MODE_mode_unload->layer = 0;
    ui_MODE_mode_unload->color = 8;
    ui_MODE_mode_unload->start_x = 1514;
    ui_MODE_mode_unload->start_y = 667;
    ui_MODE_mode_unload->width = 10;
    ui_MODE_mode_unload->r = 45;
...
ui_interface_string_t* ui_MODE_text_unload_text = &(ui_MODE_text_2.option);
...
ui_interface_string_t* ui_MODE_text_fire_text = &(ui_MODE_text_3.option);
...
void _ui_init_MODE_text_3() {
    ...
    ui_MODE_text_fire_text->figure_type = 7;
    ui_MODE_text_fire_text->operate_type = 1;
    ui_MODE_text_fire_text->layer = 0;
    ui_MODE_text_fire_text->color = 1;
    ui_MODE_text_fire_text->start_x = 397;
    ui_MODE_text_fire_text->start_y = 530;
    ui_MODE_text_fire_text->width = 2;
    ui_MODE_text_fire_text->font_size = 20;
    ui_MODE_text_fire_text->str_length = 4;
    strcpy(ui_MODE_text_fire_text->string, "FIRE");
