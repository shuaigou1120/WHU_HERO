...
//        chassis_move_control->wz_set=0;
		if(chassis_move_control->chassis_relative_angle<3 && chassis_move_control->chassis_relative_angle > -3 )
		{
			chassis_move_control->wz_set=0; 
		}
		else
...
//        chassis_move_control->vx_set = fp32_constrain(vx_set, chassis_move_control->vx_min_speed, chassis_move_control->vx_max_speed);
//        chassis_move_control->vy_set = fp32_constrain(vy_set, chassis_move_control->vy_min_speed, chassis_move_control->vy_max_speed);
		angle=(chassis_move_control->chassis_relative_angle-20)/180*3.141592654;
...
//        chassis_move_control->wz_set = angle_set;
	...
	if(((chassis_move.chassis_data_->last_keyboard&KEY_PRESSED_OFFSET_B)==0)&&chassis_move.chassis_data_->keyboard&KEY_PRESSED_OFFSET_B)
	{
		HAL_Software_Reset();
	}
