...
void shoot_feedback_update()
{
	...
	*/
	shoot_control.last_press_l=shoot_control.press_l;
	shoot_control.press_l=shoot_control.shoot_rc->rc.pause;
}
void shoot_set_mode()
{
...
*/
if((shoot_control.last_press_l==0)&&(shoot_control.press_l==1))
{
	shoot_flag=!shoot_flag;
}
...
void friction_control_set()
{
	if(shoot_control.shoot_mode==SHOOT_BULLET)
	{
		...
		shoot_control.friction_speed_set=4500;
		shoot_control.friction_speed_set_1=3375;
		laser_on();
