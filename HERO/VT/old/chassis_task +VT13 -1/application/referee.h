...
extern void get_42mm_shoot_heat_limit_and_heat(uint16_t *heat_limit_42mm, uint16_t *heat_42mm);
extern void get_power_shooter_output(uint8_t *shooter_power);

extern void get_speed_output(float *shoot_data);
extern void get_42mm_allowance(uint16_t *allowance_42mm);
